...
public class BlockBreakListener implements Listener {
	...
	public BlockBreakListener(Civilized pl) {
		this.pl = pl;
	}
	...
	public void onBlockBreak(BlockBreakEvent e) {
		...
		PermissionLevel plotPermission = plot.getPermissions().block_break;
		PermissionLevel cityPermission = city.getPermissions().block_break;
		...
		if(!hasPermission) {
			p.sendMessage(ChatColor.RED + "You do not have permission to break blocks here.");
			e.setCancelled(true);
		}
