...
public class CityPermissionsCommand extends CivilizedSubcommand {
	...
	public boolean run(CommandSender sender, String[] args) {
		...
		if (args.length < 1) {
			p.sendMessage(ChatColor.RED + "You need to provide a permission type.");
		...
		p.sendMessage(ChatColor.GREEN + "Set permission " + ChatColor.AQUA + args[0].toUpperCase() + ChatColor.GREEN + " access to " + ChatColor.AQUA + level.toString());
