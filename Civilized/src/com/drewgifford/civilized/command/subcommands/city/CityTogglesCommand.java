...
public class CityTogglesCommand extends CivilizedSubcommand {
	...
	public boolean run(CommandSender sender, String[] args) {
		...
		if (args.length < 1) {
			p.sendMessage(ChatColor.RED + "You need to provide a toggle type.");
			p.sendMessage(ChatColor.DARK_RED + "Valid permission types: " + CivilizedToggles.getOptionsString());
			return false;
		}
		...
		p.sendMessage(ChatColor.GREEN + "Set toggle " + ChatColor.AQUA + args[0].toUpperCase() + ChatColor.GREEN + " to " + ChatColor.AQUA + setTo);
